...
var author$project$Helpers$parse = function (url) {
...
var author$project$Main$Model = F6(
	function (key, url, config, encrypt, gotConfig, response) {
		return {config: config, encrypt: encrypt, gotConfig: gotConfig, key: key, response: response, url: url};
	});
var author$project$Main$Config = F9(
	function (httpPort, thingID, thingKey, ctrlChan, dataChan, logLevel, edgexURL, mqttURL, encrypt) {
		return {ctrlChan: ctrlChan, dataChan: dataChan, edgexURL: edgexURL, encrypt: encrypt, httpPort: httpPort, logLevel: logLevel, mqttURL: mqttURL, thingID: thingID, thingKey: thingKey};
	});
var author$project$Main$emptyConfg = A9(author$project$Main$Config, '', '', '', '', '', '', '', '', 'no');
	...
	function (_n0, url, key) {
		return _Utils_Tuple2(
			A6(
				...
				key,
				author$project$Helpers$parse(url),
				author$project$Main$emptyConfg,
				false,
				false,
				''),
...
var author$project$Helpers$handleError = function (error) {
	switch (error.$) {
		case 'BadUrl':
			var url = error.a;
			return 'Bad URL: ' + url;
...
var author$project$Main$PostedConfig = function (a) {
	return {$: 'PostedConfig', a: a};
};
...
var author$project$Main$configDecoder = elm$json$Json$Decode$dict(elm$json$Json$Decode$string);
...
var author$project$Main$configEncoder = function (config) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'http_port',
				elm$json$Json$Encode$string(config.httpPort)),
				_Utils_Tuple2(
				'mainflux_id',
				elm$json$Json$Encode$string(config.thingID)),
				_Utils_Tuple2(
				'mainflux_key',
				elm$json$Json$Encode$string(config.thingKey)),
				_Utils_Tuple2(
				'control_channel',
				elm$json$Json$Encode$string(config.ctrlChan)),
				_Utils_Tuple2(
				'data_channel',
				elm$json$Json$Encode$string(config.dataChan)),
				_Utils_Tuple2(
				'log_level',
				elm$json$Json$Encode$string(config.logLevel)),
				_Utils_Tuple2(
				'edgex_url',
				elm$json$Json$Encode$string(config.edgexURL)),
				_Utils_Tuple2(
				'mqtt_url',
				elm$json$Json$Encode$string(config.mqttURL)),
				_Utils_Tuple2(
				'encrypt',
				elm$json$Json$Encode$string(config.encrypt))
			]));
};
...
var author$project$Main$expectRetrieve = F2(
...
var author$project$Main$expectStatus = function (toMsg) {
	return A2(
		elm$http$Http$expectStringResponse,
		toMsg,
		function (resp) {
...
var author$project$Main$parseDictEntry = F2(
	function (key, dict) {
		...
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							url: author$project$Helpers$parse(url)
						}),
					elm$core$Platform$Cmd$none);
			case 'GetConfig':
				return _Utils_Tuple2(
					...
					elm$http$Http$get(
						{
							expect: A2(author$project$Main$expectRetrieve, author$project$Main$GotConfig, author$project$Main$configDecoder),
							url: A3(
								...
								_List_fromArray(
									[
										A2(elm$url$Url$Builder$string, 'filename', 'config'),
										A2(elm$url$Url$Builder$string, 'dir', '.')
									]))
						}));
			case 'GotConfig':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var cfgDict = result.a;
					var cfg = A9(
						author$project$Main$Config,
						A2(author$project$Main$parseDictEntry, 'http_port', cfgDict),
						A2(author$project$Main$parseDictEntry, 'mainflux_id', cfgDict),
						A2(author$project$Main$parseDictEntry, 'mainflux_key', cfgDict),
						A2(author$project$Main$parseDictEntry, 'control_channel', cfgDict),
						A2(author$project$Main$parseDictEntry, 'data_channel', cfgDict),
						A2(author$project$Main$parseDictEntry, 'log_level', cfgDict),
						A2(author$project$Main$parseDictEntry, 'edgex_url', cfgDict),
						A2(author$project$Main$parseDictEntry, 'mqtt_url', cfgDict),
						A2(author$project$Main$parseDictEntry, 'encrypt', cfgDict));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{config: cfg, gotConfig: true}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = result.a;
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					...
					elm$http$Http$post(
						{
							body: elm$http$Http$jsonBody(
								author$project$Main$configEncoder(model.config)),
							expect: author$project$Main$expectStatus(author$project$Main$PostedConfig),
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								response: author$project$Helpers$handleError(error)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'SubmitPort':
			...
			case 'SubmitMqttURL':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			default:
				var encrypt = !model.encrypt;
				var answer = encrypt ? 'yes' : 'no';
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var author$project$Helpers$faIcons = {bootstrap: 'far fa-hdd', channels: 'fas fa-broadcast-tower', connection: 'fas fa-plug', connections: 'fas fa-arrows-alt-h', dashboard: 'fas fa-chart-bar', edit: 'fa fa-pen', messages: 'far fa-paper-plane', provision: 'fa fa-plus', receive: 'fas fa-arrow-down', remove: 'fa fa-trash-alt', send: 'fas fa-arrow-up', settings: 'fas fa-cog', things: 'fas fa-sitemap', version: 'fa fa-code-branch', websocket: 'fas fa-arrows-alt-v'};
...
var author$project$Helpers$fontAwesome = A3(
	...
	_List_Nil);
var author$project$Main$Encrypt = {$: 'Encrypt'};
var author$project$Main$GetConfig = {$: 'GetConfig'};
var author$project$Main$PostConfig = {$: 'PostConfig'};
var author$project$Main$SubmitCtrlChan = function (a) {
	return {$: 'SubmitCtrlChan', a: a};
};
var author$project$Main$SubmitDataChan = function (a) {
	return {$: 'SubmitDataChan', a: a};
};
var author$project$Main$SubmitEdgexURL = function (a) {
	return {$: 'SubmitEdgexURL', a: a};
};
var author$project$Main$SubmitLogLevel = function (a) {
	return {$: 'SubmitLogLevel', a: a};
};
var author$project$Main$SubmitMqttURL = function (a) {
	return {$: 'SubmitMqttURL', a: a};
};
var author$project$Main$SubmitPort = function (a) {
	return {$: 'SubmitPort', a: a};
};
var author$project$Main$SubmitThingID = function (a) {
	return {$: 'SubmitThingID', a: a};
};
var author$project$Main$SubmitThingKey = function (a) {
	return {$: 'SubmitThingKey', a: a};
};
...
var author$project$Main$formGroup = F6(
	function (gotConfig, val, id, name, desc, msg) {
		return A2(
			...
			_List_fromArray(
				[
					...
					gotConfig ? rundis$elm_bootstrap$Bootstrap$Form$Input$text(
					_List_fromArray(
						[
											...
											_List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																A6(author$project$Main$formGroup, model.gotConfig, model.config.httpPort, 'httpPort', 'Server port', 'HTTP server port', author$project$Main$SubmitPort),
																A6(author$project$Main$formGroup, model.gotConfig, model.config.thingID, 'thingID', 'Thing ID', 'Mainflux thing ID', author$project$Main$SubmitThingID),
																A6(author$project$Main$formGroup, model.gotConfig, model.config.thingKey, 'thingKey', 'Thing Key', 'Mainflux thing key', author$project$Main$SubmitThingKey),
																A6(author$project$Main$formGroup, model.gotConfig, model.config.ctrlChan, 'ctrlChan', 'Control channel', 'Mainflux channel for sending exec and admin messages.', author$project$Main$SubmitCtrlChan),
																A6(author$project$Main$formGroup, model.gotConfig, model.config.dataChan, 'dataChan', 'Data channel', 'Mainflux channel for sending data messages.', author$project$Main$SubmitDataChan),
																A6(author$project$Main$formGroup, model.gotConfig, model.config.logLevel, 'logLevel', 'Log level', 'Mainflux logger verbosity level.', author$project$Main$SubmitLogLevel),
																A6(author$project$Main$formGroup, model.gotConfig, model.config.edgexURL, 'edgexURL', 'Edgex URL', 'Edgex server URL address.', author$project$Main$SubmitEdgexURL),
																A6(author$project$Main$formGroup, model.gotConfig, model.config.mqttURL, 'mqttURL', 'MQTT URL', 'MQTT service URL address.', author$project$Main$SubmitMqttURL),
																A2(
																rundis$elm_bootstrap$Bootstrap$Form$group,
																_List_Nil,
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				...
																				elm$html$Html$Events$onClick(author$project$Main$Encrypt)
																			]),
																		_List_Nil),
																		A2(
																		rundis$elm_bootstrap$Bootstrap$Form$label,
																		_List_fromArray(
																			[
																				elm$html$Html$Attributes$for('encrypt')
																			]),
																		_List_fromArray(
																			[
																				elm$html$Html$text('Encrypt')
																			])),
																		A2(
																		rundis$elm_bootstrap$Bootstrap$Form$help,
																		_List_Nil,
																		_List_fromArray(
																			[
																				elm$html$Html$text('Encrypt configuration.')
																			]))
																	]))
															])))
												]),
																			...
																			[
																				...
																				_List_fromArray(
																					[
																						...
																						elm$html$Html$Attributes$class(author$project$Helpers$faIcons.settings)
																					]),
																				_List_Nil),
																			...
																			[
																				...
																				_List_fromArray(
																					[
																						...
																						rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$GetConfig)
																					]),
																				_List_fromArray(
																					[
																			...
																			[
																				...
																				_List_fromArray(
																					[
																						...
																						_List_fromArray(
																							[rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1])),
																						rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$PostConfig)
																					]),
																				_List_fromArray(
																					[
